...
export interface TileShape {
  ...
  textureUrl: string
  viewBox: string
  inner: (color: string) => React.ReactNode
...
export const TILE_SHAPES: TileShape[] = [
  // ── Row 1 ────────────────────────────────────────────────────────────────
  {
    ...
    pxW: 58,
    pxH: 58,
    textureUrl: "/assets/Tile6%20new.svg",
    viewBox: "0 0 58 58",
    inner: (color) => <path d="M1 1H57V57H1V1Z" fill={color} />,
    render: (color) => (
  ...
  },
  {
    ...
    pxW: 58,
    pxH: 58,
    textureUrl: "/assets/Tile1%20new.svg",
    viewBox: "0 0 58 58",
    inner: (color) => <circle cx="29" cy="29" r="28" fill={color} />,
    render: (color) => (
      <svg viewBox="0 0 58 58" width="40" height="40" fill="none" preserveAspectRatio="xMidYMid meet">
  ...
  },
  {
    ...
    pxW: 58,
    pxH: 29,
    textureUrl: "/assets/Tile2%20new.svg",
    viewBox: "0 0 58 29",
    inner: (color) => (
  ...
  },
  {
    ...
    pxW: 58,
    pxH: 58,
    textureUrl: "/assets/Tile11%20new.svg",
    viewBox: "0 0 58 58",
    inner: (color) => <path d="M1 57H57L1 1V57Z" fill={color} />,
    render: (color) => (
      <svg viewBox="0 0 58 58" width="40" height="40" fill="none" preserveAspectRatio="xMidYMid meet">
  ...
  // ── Row 2 ────────────────────────────────────────────────────────────────
  {
    ...
    pxW: 116,
    pxH: 58,
    textureUrl: "/assets/Tile7%20new.svg",
    viewBox: "0 0 116 58",
    inner: (color) => (
  ...
  },
  {
    ...
    pxW: 58,
    pxH: 58,
    textureUrl: "/assets/Tile9%20new.svg",
    viewBox: "0 0 58 58",
    inner: (color) => (
  ...
  },
  {
    ...
    pxW: 58,
    pxH: 58,
    textureUrl: "/assets/Tile8%20new.svg",
    viewBox: "0 0 58 58",
    inner: (color) => (
  ...
  },
  {
    ...
    pxW: 116,
    pxH: 29,
    textureUrl: "/assets/Tile10%20new.svg",
    viewBox: "0 0 116 29",
    inner: (color) => (
  ...
  // ── Row 3 ────────────────────────────────────────────────────────────────
  {
    ...
    pxW: 116,
    pxH: 59,
    textureUrl: "/assets/Tile4%20new.svg",
    viewBox: "0 0 116 59",
    inner: (color) => (
  ...
  },
  {
    ...
    pxW: 116,
    pxH: 116,
    textureUrl: "/assets/Tile3%20new.svg",
    viewBox: "0 0 116 116",
    inner: (color) => (
  ...
  },
  {
    ...
    pxW: 174,
    pxH: 174,
    textureUrl: "/assets/Tile5%20new.svg",
    viewBox: "0 0 174 174",
    inner: (color) => (
